...
Original file is located at
    https://colab.research.google.com/drive/15J7Fzy50JVLr4KzhCIYqh21zXxDWI_Xs
"""
...
#membuat load dan plot input image
...
#membuat plot citra input dan output hasil dari filter batas
